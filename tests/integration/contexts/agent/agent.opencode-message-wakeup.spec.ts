...
describe('OpenCode native message transport', () => {
  it.each([
    {
      name: 'legacy top-level variant',
      modelVariant: undefined,
      variant: 'high',
      expectedVariant: 'high'
    },
    {
      name: 'nested model variant',
      modelVariant: 'high',
      variant: undefined,
      expectedVariant: 'high'
    },
    {
      name: 'current model variant takes precedence',
      modelVariant: 'high',
      variant: 'low',
      expectedVariant: 'high'
    },
    ...
    'preserves $name on resume, rejects busy delivery and closes its listener',
    async ({ modelVariant, variant, expectedVariant }) => {
      ...
      try {
                ...
                data: [
                  {
                    info: {
                      ...
                      model: {
                        providerID: 'test',
                        modelID: 'chosen',
                        ...(modelVariant === undefined ? {} : { variant: modelVariant })
                      },
        ...
        expect(nativeConfig.mcp.cleancode.headers.Authorization).toBe(
          'Bearer launch-mcp-credential'
        )
