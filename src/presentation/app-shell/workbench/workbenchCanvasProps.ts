...
import type { AgentToolApprovalViewState } from './nodes/agent/agentToolApprovalTypes'
...
import type { MinimapNodeInteractionContextValue } from './minimap/minimapInteraction'
