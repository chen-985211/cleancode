...
export const enMessages = {
  ...
  'agent.activity.waiting_input': 'Waiting for input',
  'agent.activity.waiting_approval': 'Waiting for approval',
  ...
  'agent.providerPicker.checking': 'Checking CLI…',
  'agent.providerPicker.unknown': 'CLI status unavailable',
  'agent.providerPicker.notInstalled': '{provider} CLI not installed',
  'agent.providerPicker.upgradeRequired': '{provider} {minimumVersion}+ required',
