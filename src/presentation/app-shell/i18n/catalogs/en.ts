...
export const enMessages = {
  ...
  'agent.providerPicker.dialog': 'Choose Agent Provider',
  'agent.providerPicker.title': 'Choose Agent Provider',
  'agent.providerPicker.description': 'Create an independent Agent terminal in this workspace.',
  'agent.providerPicker.fixedHint': 'Provider cannot be changed after creation.',
  'agent.providerPicker.resume': 'Conversation resume',
  'agent.providerPicker.mcp': 'CleanCode MCP',
  'agent.providerPicker.terminal': 'Terminal mode',
  'agent.providerPicker.discovering': 'Detecting available Agents…',
  'agent.providerPicker.emptyTitle': 'No available Agent CLI detected',
  'agent.providerPicker.emptyDescription': 'Install a supported Agent CLI, then detect again.',
  'agent.providerPicker.refresh': 'Detect again',
  'agent.providerPicker.discoveryFailed': 'Could not detect available Agents. Detect again.',
  'agent.providerPicker.creationFailed': 'Could not create the Agent. Select it or try again.',
  'agent.providerPicker.creating': 'Creating…',
