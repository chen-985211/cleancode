...
export const enMessages = {
  ...
  'quickExecution.boundSlot': 'Quick slot {number}: {name}. Run with the keyboard shortcut only.',
  ...
  'quickExecution.moveLeft': 'Move left',
  'quickExecution.moveRight': 'Move right',
  'quickExecution.clear': 'Clear slot',
