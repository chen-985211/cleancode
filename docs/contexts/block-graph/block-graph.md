...
模板表现层由 [`block-graph.block-template-library.presentation.spec.tsx`](../../../tests/unit/contexts/block-graph/block-graph.block-template-library.presentation.spec.tsx) 和 [`block-graph.block-template-save-dialog.presentation.spec.tsx`](../../../tests/unit/contexts/block-graph/block-graph.block-template-save-dialog.presentation.spec.tsx) 证明筛选、维护、放置意图、保存输入、焦点和受控退出。
