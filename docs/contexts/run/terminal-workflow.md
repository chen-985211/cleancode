...
| Presentation           | [`terminalWorkflowSessionEvents.ts`](../../../src/contexts/run/presentation/view-models/terminalWorkflowSessionEvents.ts)、[`useTerminalWorkflow.ts`](../../../src/presentation/app-shell/useTerminalWorkflow.ts)、[`useTerminalWorkflowNotifications.ts`](../../../src/presentation/app-shell/useTerminalWorkflowNotifications.ts)、[`terminalWorkflowNotifications.ts`](../../../src/presentation/app-shell/terminalWorkflowNotifications.ts)、[`terminalWorkflowEdges.ts`](../../../src/presentation/app-shell/terminalWorkflowEdges.ts)、终端节点与通知 |
