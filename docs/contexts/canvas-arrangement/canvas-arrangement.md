...
| Presentation   | [`presentation`](../../../src/contexts/canvas-arrangement/presentation)、[`workbenchCanvasArrangementSelection.ts`](../../../src/presentation/app-shell/workbenchCanvasArrangementSelection.ts)、[`useCanvasArrangementActions.ts`](../../../src/presentation/app-shell/useCanvasArrangementActions.ts)     |
