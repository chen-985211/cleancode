...
| Platform / UI    | [`agentIpcHandlers.ts`](../../../src/platform/electron-main/agentIpcHandlers.ts)、[`AgentActivityObserver.tsx`](../../../src/presentation/app-shell/AgentActivityObserver.tsx)、[`agentActivityStore.ts`](../../../src/presentation/app-shell/agentActivityStore.ts)、[`AgentConsole.tsx`](../../../src/presentation/app-shell/AgentConsole.tsx)                                                                                                                                                                                                                                |
...
| Unit / UI   | 未知 Provider 通用投影、安静 baseline、全局快照、等待/完成消息、revision/completion 去重、来源定位和 attach 失败隔离            | [`agent-console.provider-neutral.spec.tsx`](../../../tests/unit/presentation/agent-console.provider-neutral.spec.tsx)、[`agent-console.attach-lifecycle.spec.tsx`](../../../tests/unit/presentation/agent-console.attach-lifecycle.spec.tsx)、[`agent-activity-store.spec.ts`](../../../tests/unit/presentation/agent-activity-store.spec.ts)、[`agent-activity-notifications.spec.tsx`](../../../tests/unit/presentation/agent-activity-notifications.spec.tsx)、[`agent-activity-notification-navigation.spec.tsx`](../../../tests/unit/presentation/agent-activity-notification-navigation.spec.tsx)                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Integration | schema v5 严格校验、真实 Agent terminal、CLI 退出回 shell、普通终端命令 shim 与真实 Hook relay                                  | [`agent.session-persistence.spec.ts`](../../../tests/integration/contexts/agent/agent.session-persistence.spec.ts)、[`agent.run-terminal-provider.spec.ts`](../../../tests/integration/contexts/agent/agent.run-terminal-provider.spec.ts)、[`agent.terminal-activity-shim.spec.ts`](../../../tests/integration/contexts/agent/agent.terminal-activity-shim.spec.ts)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
