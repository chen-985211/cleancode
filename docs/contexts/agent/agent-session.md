...
| Platform / UI    | [`agentIpcHandlers.ts`](../../../src/platform/electron-main/agentIpcHandlers.ts)、[`AgentActivityObserver.tsx`](../../../src/contexts/agent/presentation/components/AgentActivityObserver.tsx)、[`AgentCanvasContextActions.tsx`](../../../src/contexts/agent/presentation/components/AgentCanvasContextActions.tsx)、[`agentActivityStore.ts`](../../../src/contexts/agent/presentation/view-models/agentActivityStore.ts)、[`AgentConsole.tsx`](../../../src/presentation/app-shell/AgentConsole.tsx)                                                                         |
