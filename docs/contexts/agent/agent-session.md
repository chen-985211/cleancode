...
| Unit / UI   | 未知 Provider 通用投影、安静 baseline、全局快照、等待/完成消息、revision/completion 去重和 attach 失败隔离                      | [`agent-console.provider-neutral.spec.tsx`](../../../tests/unit/presentation/agent-console.provider-neutral.spec.tsx)、[`agent-console.attach-lifecycle.spec.tsx`](../../../tests/unit/presentation/agent-console.attach-lifecycle.spec.tsx)、[`agent-activity-store.spec.ts`](../../../tests/unit/presentation/agent-activity-store.spec.ts)、[`agent-activity-notifications.spec.tsx`](../../../tests/unit/presentation/agent-activity-notifications.spec.tsx)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
