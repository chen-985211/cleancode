...
| Presentation projection       | [`agentApprovalPresentation.ts`](../../../src/presentation/app-shell/projections/agentApprovalPresentation.ts)、[`useAgentLayoutCoordination.ts`](../../../src/presentation/app-shell/coordinators/useAgentLayoutCoordination.ts)、[`terminalWorkflowBuildChoreography.ts`](../../../src/presentation/app-shell/terminalWorkflowBuildChoreography.ts)、[`useTerminalWorkflowBuildChoreography.ts`](../../../src/presentation/app-shell/coordinators/useTerminalWorkflowBuildChoreography.ts)、[`useWorkbenchLayoutFocus.ts`](../../../src/presentation/app-shell/useWorkbenchLayoutFocus.ts) |
