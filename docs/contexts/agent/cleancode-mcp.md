...
| Presentation projection       | [`agentApprovalPresentation.ts`](../../../src/presentation/app-shell/agentApprovalPresentation.ts)、[`useAgentLayoutCoordination.ts`](../../../src/presentation/app-shell/useAgentLayoutCoordination.ts)、[`terminalWorkflowBuildChoreography.ts`](../../../src/presentation/app-shell/terminalWorkflowBuildChoreography.ts)、[`useTerminalWorkflowBuildChoreography.ts`](../../../src/presentation/app-shell/useTerminalWorkflowBuildChoreography.ts)、[`useWorkbenchLayoutFocus.ts`](../../../src/presentation/app-shell/useWorkbenchLayoutFocus.ts) |
